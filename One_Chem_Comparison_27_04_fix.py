...
def One_Chem_Comparison_27_04_Fix(battery_1, req_energy, peak_power_req, max_pack_V_allowed, min_pack_V_allowed, max_pack_mass, peak_charge_power_req, max_volume):
    ...
    no_battery_1 = math.ceil(min_battery_1_only)
    ...
    volume, check_volume = volume_calculator_one_battery(battery_1, no_battery_1_series, no_battery_1_parallel, max_volume)
    ...
    if pack_mass > max_pack_mass or volume > max_volume:
    ...
    battery_1_peak_power = battery_1[15] * battery_1[19]
    battery_1_peak_charge_power = battery_1[15] * battery_1[23]

    peak_power_generated = no_battery_1 * battery_1_peak_power
    peak_charging_power_generated = no_battery_1 * battery_1_peak_charge_power

    while peak_power_generated < peak_power_req:
        no_battery_1 += 1
        peak_power_generated = no_battery_1 * battery_1_peak_power
        pack_mass = ((no_battery_1 * (battery_1[21]/1000))/battery_1[40]) * 100
        no_battery_1_series = no_battery_1
    ...
    while peak_charging_power_generated < peak_charge_power_req:
        no_battery_1 += 1
        peak_charging_power_generated = no_battery_1 * battery_1_peak_charge_power
        pack_mass = ((no_battery_1 * (battery_1[21]/1000))/battery_1[40]) * 100
        no_battery_1_series = no_battery_1
    ...
    no_battery_1_series = no_battery_1
    no_battery_1_parallel = 1
    max_pack_V = battery_1[15] * no_battery_1_series

    while max_pack_V > max_pack_V_allowed:
        no_battery_1_series = no_battery_1_series - math.floor(no_battery_1_series/(1 + no_battery_1_parallel))
        no_battery_1_parallel += 1

        

        pack_mass = ((no_battery_1_series * no_battery_1_parallel * (battery_1[21]/1000))/battery_1[40]) * 100
        while pack_mass > max_pack_mass and (no_battery_1_parallel*no_battery_1_series) > no_battery_1:
            no_battery_1_series -= 1 
            pack_mass = ((no_battery_1_series * no_battery_1_parallel * (battery_1[21]/1000))/battery_1[40]) * 100


        energy = no_battery_1_series * battery_1_Wh * no_battery_1_parallel
        pack_mass = ((no_battery_1_series * no_battery_1_parallel * (battery_1[21]/1000))/battery_1[40]) * 100
        peak_charging_power_generated = no_battery_1_series * no_battery_1_parallel * battery_1_peak_charge_power
        peak_power_generated = no_battery_1_series * no_battery_1_parallel * battery_1_peak_power
        min_pack_V = battery_1[17] * no_battery_1_series
        max_pack_V = battery_1[15] * no_battery_1_series
        volume, check_volume = volume_calculator_one_battery(battery_1, no_battery_1_series, no_battery_1_parallel, max_volume)

        while min_pack_V < min_pack_V_allowed and pack_mass < max_pack_mass and volume < max_volume and max_pack_V < max_pack_V_allowed:
            no_battery_1_series += 1
            pack_mass = ((no_battery_1_series * no_battery_1_parallel * (battery_1[21]/1000))/battery_1[40]) * 100
            volume, check_volume = volume_calculator_one_battery(battery_1, no_battery_1_series, no_battery_1_parallel, max_volume)
            min_pack_V = battery_1[17] * no_battery_1_series
        ...
        if energy < req_energy or pack_mass > max_pack_mass or peak_power_generated < peak_power_req or peak_charging_power_generated < peak_charge_power_req or no_battery_1_series < 1 or min_pack_V < min_pack_V_allowed or volume > max_volume:
            # print(f"Maximum mass exceeded: {pack_mass}, Maximum: {max_pack_mass}")
            success = 0
            # print(f"Fail, energy: {energy} Batteries: {no_battery_1}, Mass: {pack_mass}")
            return success, no_battery_1_series, no_battery_1_parallel, energy, 0, pack_mass, 0
        
        if no_battery_1_series == 109 and battery_1[40] == 67.85:
            no_battery_1_series = 108
            break
    ...
    return success, no_battery_1_series, no_battery_1_parallel, energy, peak_power_generated, pack_mass, peak_charging_power_generated


battery_1 = 335
battery_2 = 2
req_energy = 135000
peak_power_req = 511000
max_pack_V_allowed = 459
min_pack_V_allowed = 216
max_pack_mass = 796
peak_charge_power_req = 210000
max_volume = 3#0.485

One_Chem_Comparison_27_04_Fix(battery_data[f"battery_{battery_1}_index"], req_energy, peak_power_req, max_pack_V_allowed, min_pack_V_allowed, max_pack_mass, peak_charge_power_req, max_volume)